...
class GenericLayettesDatasource {
 static const String _baseUrl = AppNetwork.urlBaseVercel;
  ...
  AsyncResult<Map<String, dynamic>> fetchGenericLayette(LayetteProfileEntity profile) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return Failure(ClientException(errorMessage: 'Erro ao gerar a lista de enxoval', statusCode: response.statusCode ));
